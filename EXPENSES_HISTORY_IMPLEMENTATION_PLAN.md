...
Depends on: PR 6
Requirements: R13–R23, R33–R38; D13–D14
...
- [x] Focus restoration, keyboard access, responsive table containment, and direct-route navigation are preserved by the shared route/modal/table primitives and verified through typed route generation, accessibility checks, production output, and focused code review.
